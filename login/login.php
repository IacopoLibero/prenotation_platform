...
$checkQuery = "SELECT *, 'professore' as tipo FROM `Professori` WHERE email = ? 
              UNION 
              SELECT *, NULL as bio, NULL as materie, NULL as google_calendar_link, NULL as google_calendar_id, 'studente' as tipo FROM `Studenti` WHERE email = ?";
